...
import { AppBar, Button, Toolbar,Typography,Grid ,Paper} from '@material-ui/core';
...
function Navbar() {
  ...
  return (
    ...
    <AppBar position="sticky" color="default" elevation={0}  className={classes.appBar} style={{backgroundColor: '#EDEEF1',maxWidth: "83.75rem",margin:"auto"}}>
      <Toolbar style={{ justifyContent: 'space-between', backgroundColor: '#EDEEF1',width: "83.75rem",marginBottom:'1.3rem',padding:0,marginLeft:"auto",marginRight:"auto" }}>
        ...
        <Grid container style={{marginLeft:'16.7395rem',width:'65.3125rem',height:'3rem',}}>
          ...
          <Typography variant='caption' style={{fontFamily:'Inter',padding:'.45rem',fontWeight:500,color:'#292D32'}}>  Projects</Typography>
          </Button></a>
          <a href="#overview" style={{ textDecoration: 'none' }}>
          <Button color="inherit" className={classes.button}>
          <Typography variant='caption' style={{fontFamily:'Inter',margin:'.45rem',fontWeight:500,color:'#292D32'}}> Overview</Typography>
          </Button></a>
          <a href="#categories" style={{ textDecoration: 'none' }}>
          <Button color="inherit" className={classes.button}>
          <Typography variant='caption' style={{fontFamily:'Inter',margin:'.45rem',fontWeight:500,color:'#292D32'}}> Categories</Typography>
          </Button></a>
          <a href="#whyshuru" style={{ textDecoration: 'none' }}>
          <Button color="inherit" className={classes.button}>
          <Typography variant='caption' style={{fontFamily:'Inter',margin:'.45rem',fontWeight:500,color:'#292D32'}}> Why Shuru</Typography>
          </Button></a>
          <a href="#howitworks" style={{ textDecoration: 'none' }}>
          <Button color="inherit" className={classes.button}>
          <Typography variant='caption' style={{fontFamily:'Inter',margin:'.45rem',fontWeight:500,color:'#292D32'}}> How it works</Typography>
          </Button></a>
          <a href="#aboutus" style={{ textDecoration: 'none' }}>
          <Button color="inherit" className={classes.button}>
          <Typography variant='caption' style={{fontFamily:'Inter',margin:'.45rem',fontWeight:500,color:'#292D32'}}> About </Typography>
          </Button></a>
          <a href="#benefits" style={{ textDecoration: 'none' }}>
          <Button color="inherit" className={classes.button}>
          <Typography variant='caption' style={{fontFamily:'Inter',margin:'.45rem',fontWeight:500,color:'#292D32'}}>   Benefits </Typography>
          </Button></a>
